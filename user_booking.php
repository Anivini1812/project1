						...
						<nav class="navbar navbar-default">
							...
							<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
								<ul class="nav navbar-nav navbar-right">
									...
									<li><a href="user_vehicle.php">Vehicle</a></li>
									<li><a href="user_booking.php" class="active">Booking</a></li>
...
<!-- //banner -->
	...
	<div class="main-textgrids">
		...
		<div class="w3l-heading">
				<h2 class="w3ls_head">booking details </h2>
		  </div>
			 <form name="form1" method="post" action="">
			   <table width="80%" height="127" align="center">
                 <tr>
                   <td>Id</td>
                   <td> Vehicle Name</td>
                   <td>Type</td>
                 ...
                 <?php
	 $qrys1="select * from  user_booking where user='$email'";
	 ...
	 ?>
                 <tr>
                   ...
                   <td><img src="upload/<?php echo $row['fname'];?>" width="100" height="100"></td>
                 </tr>
                 <?php
	 }
	 ?>
